...
\]
	\item The matrix has two eigenvalues: $2\lambda_3 + 1$, $2\lambda_3 - 1$. Thus,  $L(x_1, x_2, \lambda_1, \lambda_2, \lambda_3) $ takes the following three shapes: 
\begin{figure}
      \begin{minipage}{0.30\textwidth}%
...
\begin{array}{lllll} 
	...
	&=&  
	 \begin{cases}  - \tfrac{1}{2} \left[\lambda_1 \lambda_2 \right] \left[ \begin{matrix}  2\lambda_3 & 1 \\ 1 & 2\lambda_3 \end{matrix} \right]^{-1}  \left[ \begin{matrix} \lambda_1 \\ \lambda_2 \end{matrix}\right]   -\lambda_3 & \text{if } \lambda_3 > \tfrac{1}{2} \\  
	 	 				\leq \tfrac{1}{2} & \text{if }  \lambda_3 = \tfrac{1}{2} \\
	 	 				-\infty & \text{if }  \lambda_3 < \tfrac{1}{2} \\
