...
\item We rewrite Lagrangian function as: 
\[
...
\]
	\item The matrix has two eigenvalues $2\lambda_3 + 1$, $2\lambda_3 - 1$. The three cases $\lambda_3 <, =, > \tfrac{1}{2}$ lead to three shapes of Lagrangian:  
\begin{figure}
      \begin{minipage}{0.30\textwidth}%
