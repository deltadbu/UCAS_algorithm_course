...
% Hint: Step 1. Consider a tree. In a tree, the path from $s_i$ to $t_i$ is unique. Thus, it is easy to design an algorithm to find disjoint paths in a tree. 
%  	
%       Step 2. Expand the algorithm to a tree-decomposition. Since the tree-width is $2$, an enumeration of edges connecting two nodes will take at most $9$ steps. 
